...
// Dashboard eksekutif untuk monitoring bantuan keuangan desa
...
// ─── EXECUTIVE HERO ─────────────────────────────────────────────────
const ExecutiveHero = ({ activeYear, setActiveYear, summary, totalAnggaran, totalProposals, showDetailAnggaran, setShowDetailAnggaran }) => {
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 pb-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-[11px] font-semibold text-blue-400 uppercase tracking-[0.15em]">Dashboard Eksekutif</p>
              <p className="text-xs text-slate-400">DPMD Kabupaten Bogor · Data Real-Time</p>
            </div>
          </div>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black text-white tracking-tight leading-[1.1] mb-2">
          ...
          <p className="text-slate-400 text-sm sm:text-base max-w-xl mt-3 leading-relaxed">
            Monitoring transparansi pengajuan dan verifikasi bantuan keuangan infrastruktur desa Kabupaten Bogor.
          </p>
        </motion.div>
...
const BankeuPublicPage = () => {
    ...
    return (
      <div className="min-h-screen bg-[#0f172a] flex items-center justify-center">
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-center">
          ...
          <p className="text-slate-400 font-medium">Memuat data bantuan keuangan...</p>
        </motion.div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Navbar */}
      <div className="sticky top-0 z-50 bg-[#0f172a]/95 backdrop-blur-xl border-b border-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex items-center justify-between">
          <button onClick={() => navigate('/')} className="inline-flex items-center gap-2 text-slate-400 hover:text-white font-medium transition-colors group">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div className="hidden sm:block">
              <p className="text-sm font-bold text-white leading-tight">DPMD Kabupaten Bogor</p>
              <p className="text-[10px] text-slate-500">Bantuan Keuangan Desa</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}
            ...
            <div className="h-64">
              {pieChartData.length > 0 ? (
                <ResponsiveContainer width="100%" height="100%" minWidth={0} minHeight={0}>
                  <PieChart>
                    <Pie data={pieChartData} cx="50%" cy="50%" innerRadius={55} outerRadius={95} paddingAngle={4} dataKey="value"

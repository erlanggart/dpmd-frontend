...
const StatistikBankeuT1 = () => {
  ...
  const fetchData = async () => {
    try {
      setLoading(true);
      const endpoint = isVpnUser() ? '/vpn-core/bankeu-t1/data' : '/bankeu-t1/data';
      const response = await api.get(endpoint);
      setData(response.data.data || []);
      setError(null);
    } catch (err) {
      console.error('Error fetching Bantuan Keuangan Tahap 1 data:', err);
      setError('Gagal memuat data Bantuan Keuangan Tahap 1');
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleExport = () => {
    ...
    XLSX.utils.book_append_sheet(wb, ws, 'Statistik Bantuan Keuangan Tahap 1');
    XLSX.writeFile(wb, `Statistik_Bantuan Keuangan Tahap 1_${new Date().toISOString().split('T')[0]}.xlsx`);
  };
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-cyan-50 to-blue-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-lg text-gray-600 font-medium">Memuat data Bantuan Keuangan Tahap 1...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-cyan-50 to-blue-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full border-l-4 border-red-500">
          ...
          <button
            onClick={fetchData}
            className="w-full bg-gradient-to-r from-cyan-600 to-blue-600 text-white py-3 rounded-xl hover:from-cyan-700 hover:to-blue-700 transition-all duration-300 font-semibold shadow-lg hover:shadow-xl"
          >
            Coba Lagi
          </button>
        </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-cyan-50 to-blue-50 p-4 md:p-6 lg:p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <button
          ...
          className="group flex items-center gap-2 text-gray-600 hover:text-cyan-600 mb-6 transition-all duration-300 bg-white px-4 py-2 rounded-xl shadow-md hover:shadow-lg"
        >
        ...
        {/* Hero Header */}
        <div className="relative bg-gradient-to-r from-cyan-600 via-cyan-700 to-blue-700 rounded-3xl shadow-2xl p-8 mb-8 overflow-hidden">
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h1 className="text-3xl md:text-4xl font-bold text-white drop-shadow-lg">
                  Statistik Bantuan Keuangan Tahap 1
                </h1>
                <p className="text-cyan-100 mt-1">Dana Desa</p>
              </div>
            </div>

            {/* Quick Stats Pills */}
            <div className="flex flex-wrap gap-3 mt-6">
              <div className="bg-cyan-600 bg-opacity-80 backdrop-blur-md rounded-xl px-4 py-2 border border-cyan-400 border-opacity-50 flex items-center gap-2 shadow-lg">
        ...
        <div className="relative bg-white rounded-2xl shadow-xl p-6 md:p-8 mb-8 overflow-hidden border border-gray-100">
          ...
          <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-br from-cyan-100 to-blue-100 opacity-30 rounded-full -mr-32 -mt-32"></div>
          <div className="absolute bottom-0 left-0 w-48 h-48 bg-gradient-to-tr from-cyan-50 to-blue-50 opacity-50 rounded-full -ml-24 -mb-24"></div>
          ...
          <div className="relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
              <div className="bg-gradient-to-br from-cyan-50 to-blue-50 rounded-xl p-6 border border-cyan-100 shadow-md hover:shadow-lg transition-shadow duration-300">
                <div className="flex items-center gap-3 mb-2">
                  <div className="w-12 h-12 bg-cyan-500 bg-opacity-20 rounded-xl flex items-center justify-center">
                    <Users className="w-6 h-6 text-cyan-600" />
                  </div>
                  <div>
                    <p className="text-sm text-gray-600 font-medium">Total Desa</p>
                    <p className="text-2xl md:text-3xl font-bold text-cyan-600">{totalDesa}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-cyan-50 to-blue-50 rounded-xl p-6 border border-cyan-100 shadow-md hover:shadow-lg transition-shadow duration-300">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-base md:text-lg font-bold text-cyan-600 break-words">{formatRupiah(avgPerDesa)}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mt-6 flex justify-end">
              <button
                ...
                className="bg-gradient-to-r from-cyan-600 to-blue-600 text-white px-6 py-3 rounded-xl hover:from-cyan-700 hover:to-blue-700 transition-all duration-300 font-semibold shadow-lg hover:shadow-xl flex items-center gap-2"
              >
        ...
        <div className="space-y-6 md:space-y-8">
          ...
          <div className="bg-gradient-to-br from-white via-cyan-50 to-blue-50 rounded-3xl shadow-2xl p-6 md:p-8 border border-cyan-100 hover:shadow-3xl transition-all duration-300">
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="px-4 py-2 bg-gradient-to-r from-cyan-500 to-blue-500 text-white rounded-full text-sm font-semibold shadow-lg">
...
export default StatistikBankeuT1;

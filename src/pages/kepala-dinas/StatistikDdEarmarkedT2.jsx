...
const CACHE_KEY = 'statistik-dd-earmarked-t2';
...
const StatistikDdEarmarkedT2 = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      console.error('Error fetching DD Earmarked Tahap 2 data:', err);
      setError('Gagal memuat data DD Earmarked Tahap 2');
    } finally {
      setLoading(false);
    }
  };
  ...
  const statusChartData = {
    ...
    datasets: [{
      ...
      backgroundColor: [
        'rgba(147, 51, 234, 0.8)',  // blue
        'rgba(236, 72, 153, 0.8)',  // indigo
        'rgba(168, 85, 247, 0.8)',  // violet
        'rgba(219, 39, 119, 0.8)',  // fuchsia
        'rgba(192, 132, 252, 0.8)', // blue light
      ],
      borderColor: [
        'rgba(147, 51, 234, 1)',
        'rgba(236, 72, 153, 1)',
  ...
  const handleExport = () => {
    ...
    XLSX.utils.book_append_sheet(wb, ws, 'Statistik DD Earmarked Tahap 2');
    XLSX.writeFile(wb, `Statistik_DD Earmarked Tahap 2_${new Date().toISOString().split('T')[0]}.xlsx`);
  };
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-lg text-gray-600 font-medium">Memuat data DD Earmarked Tahap 2...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-50 p-4 md:p-6 lg:p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative bg-gradient-to-r from-blue-600 via-blue-700 to-indigo-700 rounded-3xl shadow-2xl p-8 mb-8 overflow-hidden">
          ...
          <div className="absolute top-1/2 right-1/4 w-40 h-40 bg-indigo-400 opacity-20 rounded-full blur-3xl"></div>
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h1 className="text-3xl md:text-4xl font-bold text-white drop-shadow-lg">
                  Statistik DD Earmarked Tahap 2
                </h1>
        ...
        <div className="relative bg-white rounded-2xl shadow-xl p-6 md:p-8 mb-8 overflow-hidden border border-gray-100">
          ...
          <div className="absolute bottom-0 left-0 w-48 h-48 bg-gradient-to-tr from-blue-50 to-indigo-50 opacity-50 rounded-full -ml-24 -mb-24"></div>
          ...
          <div className="relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
              <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-6 border border-blue-100 shadow-md hover:shadow-lg transition-shadow duration-300">
            ...
            <div className="mt-6 flex justify-end">
              <button
                ...
                className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-6 py-3 rounded-xl hover:from-blue-700 hover:to-indigo-700 transition-all duration-300 font-semibold shadow-lg hover:shadow-xl flex items-center gap-2"
              >

...
import { ArrowLeft, Users, TrendingUp, BarChart3, Activity, DollarSign } from 'lucide-react';
...
const StatistikAdd = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      console.error('Error fetching ADD data:', err);
      setError('Gagal memuat data ADD');
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleExport = () => {
    ...
    XLSX.utils.book_append_sheet(wb, ws, 'Statistik ADD');
    XLSX.writeFile(wb, `Statistik_ADD_${new Date().toISOString().split('T')[0]}.xlsx`);
  };
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-purple-50 to-pink-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-lg text-gray-600 font-medium">Memuat data ADD...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-purple-50 to-pink-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full border-l-4 border-red-500">
          ...
          <button
            onClick={fetchData}
            className="w-full bg-gradient-to-r from-purple-600 to-pink-600 text-white py-3 rounded-xl hover:from-purple-700 hover:to-pink-700 transition-all duration-300 font-semibold shadow-lg hover:shadow-xl"
          >
            Coba Lagi
          </button>
        </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-purple-50 to-pink-50 p-4 md:p-6 lg:p-8">
      <div className="max-w-7xl mx-auto">
        {/* Back Button */}
        <button
          onClick={() => navigate('/core-dashboard/dashboard')}
          className="group flex items-center gap-2 text-gray-600 hover:text-purple-600 mb-6 transition-all duration-300 bg-white px-4 py-2 rounded-xl shadow-md hover:shadow-lg"
        >
        ...
        {/* Hero Header */}
        <div className="relative bg-gradient-to-r from-purple-600 via-purple-700 to-pink-700 rounded-3xl shadow-2xl p-8 mb-8 overflow-hidden">
          ...
          <div className="absolute top-1/2 right-1/4 w-40 h-40 bg-pink-400 opacity-20 rounded-full blur-3xl"></div>
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-purple-100 mt-1">Alokasi Dana Desa</p>
              </div>
            </div>
        ...
        <div className="relative bg-white rounded-2xl shadow-xl p-6 md:p-8 mb-8 overflow-hidden border border-gray-100">
          ...
          <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-br from-purple-100 to-pink-100 opacity-30 rounded-full -mr-32 -mt-32"></div>
          <div className="absolute bottom-0 left-0 w-48 h-48 bg-gradient-to-tr from-purple-50 to-pink-50 opacity-50 rounded-full -ml-24 -mb-24"></div>
          ...
          <div className="relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
              <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-6 border border-purple-100 shadow-md hover:shadow-lg transition-shadow duration-300">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <div>
                    ...
                    <p className="text-3xl font-bold text-purple-600">{totalDesa}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-6 border border-purple-100 shadow-md hover:shadow-lg transition-shadow duration-300">
                <div className="flex items-center gap-3 mb-2">
                  <div className="w-12 h-12 bg-pink-500 bg-opacity-20 rounded-xl flex items-center justify-center">
                    <DollarSign className="w-6 h-6 text-pink-600" />
                  </div>
                  <div>
                    <p className="text-sm text-gray-600 font-medium">Total Alokasi</p>
                    <p className="text-2xl font-bold text-pink-600">{formatRupiah(totalAlokasi)}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-6 border border-purple-100 shadow-md hover:shadow-lg transition-shadow duration-300">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-bold text-purple-600">{formatRupiah(avgPerDesa)}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mt-6 flex justify-end">
              <button
                ...
                className="bg-gradient-to-r from-purple-600 to-pink-600 text-white px-6 py-3 rounded-xl hover:from-purple-700 hover:to-pink-700 transition-all duration-300 font-semibold shadow-lg hover:shadow-xl flex items-center gap-2"
              >

...
const CACHE_KEY = 'statistik-dd-earmarked-t1';
...
const StatistikDdEarmarkedT1 = () => {
  ...
  const fetchData = async () => {
    try {
      setLoading(true);
      const endpoint = isVpnUser() ? '/vpn-core/dd-earmarked-t1/data' : '/dd-earmarked-t1/data';
      ...
      console.error('Error fetching DD Earmarked Tahap 1 data:', err);
      setError('Gagal memuat data DD Earmarked Tahap 1');
    } finally {
      setLoading(false);
    }
  };
  ...
  const statusChartData = {
    ...
    datasets: [{
      ...
      backgroundColor: [
        'rgba(147, 51, 234, 0.8)',  // cyan
        'rgba(236, 72, 153, 0.8)',  // blue
        'rgba(168, 85, 247, 0.8)',  // violet
        'rgba(219, 39, 119, 0.8)',  // fuchsia
        'rgba(192, 132, 252, 0.8)', // cyan light
      ],
      borderColor: [
        'rgba(147, 51, 234, 1)',
        'rgba(236, 72, 153, 1)',
  ...
  const handleExport = () => {
    ...
    XLSX.utils.book_append_sheet(wb, ws, 'Statistik DD Earmarked Tahap 1');
    XLSX.writeFile(wb, `Statistik_DD Earmarked Tahap 1_${new Date().toISOString().split('T')[0]}.xlsx`);
  };
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-cyan-50 to-blue-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-lg text-gray-600 font-medium">Memuat data DD Earmarked Tahap 1...</p>
        </div>
      </div>
    );
  }
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h1 className="text-3xl md:text-4xl font-bold text-white drop-shadow-lg">
                  Statistik DD Earmarked Tahap 1
                </h1>

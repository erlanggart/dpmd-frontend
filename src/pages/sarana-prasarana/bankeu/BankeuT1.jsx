...
const BankeuT1 = () => {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const response = await api.post('/bankeu-t1/upload', formData, {
  ...
  const handleExport = () => {
    ...
    XLSX.utils.book_append_sheet(wb, ws, 'Bantuan Keuangan Tahap 1');
    XLSX.writeFile(wb, `Bantuan_Keuangan_T1_${new Date().toISOString().split('T')[0]}.xlsx`);
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-cyan-50 to-blue-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full border-l-4 border-red-500">
          ...
          <button onClick={fetchData} className="w-full bg-cyan-600 text-white py-3 rounded-xl hover:bg-cyan-700 font-semibold">
            Coba Lagi
          </button>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-cyan-50 to-blue-50 p-4 md:p-6 lg:p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative bg-gradient-to-r from-cyan-600 via-cyan-700 to-blue-700 rounded-3xl shadow-2xl p-8 mb-8 overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h1 className="text-3xl md:text-4xl font-bold text-white drop-shadow-lg">Bantuan Keuangan Tahap 1</h1>
                <p className="text-cyan-100 mt-1">Dana Desa</p>
              </div>
            </div>
            <div className="flex flex-wrap gap-3 mt-6">
              <div className="bg-cyan-600 bg-opacity-80 backdrop-blur-md rounded-xl px-4 py-2 flex items-center gap-2 shadow-lg">
        ...
        <div className="relative bg-white rounded-2xl shadow-xl p-6 md:p-8 mb-8 overflow-hidden border border-gray-100">
          <div className="relative z-10">
            <div className="flex justify-between items-start mb-6">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="bg-gradient-to-r from-cyan-600 to-blue-600 text-white px-4 py-2 rounded-xl hover:from-cyan-700 hover:to-blue-700 font-semibold shadow-lg flex items-center gap-2"
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
              <div className="bg-gradient-to-br from-cyan-50 to-blue-50 rounded-xl p-6 border border-cyan-100 shadow-md">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-3xl font-bold text-cyan-600">{totalDesa}</p>
                  </div>
                </div>
              </div>
              <div className="bg-gradient-to-br from-cyan-50 to-blue-50 rounded-xl p-6 border border-cyan-100 shadow-md">
              ...
              <div className="bg-gradient-to-br from-cyan-50 to-blue-50 rounded-xl p-6 border border-cyan-100 shadow-md">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-lg font-bold text-cyan-600 break-words">{formatRupiah(avgPerDesa)}</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="space-y-6 md:space-y-8">
          {/* Bar Chart */}
          <div className="bg-gradient-to-br from-white via-cyan-50 to-blue-50 rounded-3xl shadow-2xl p-6 md:p-8 border border-cyan-100">
                      ...
                      <React.Fragment key={kecamatan}>
                        ...
                        {isExpanded && items.map((item, index) => (
                          <tr key={`${item.desa}-${index}`} className="hover:bg-gray-50">
                            ...
                            <td className="px-6 py-4 text-right font-semibold text-cyan-700">{formatRupiah(item.realisasi)}</td>
                          </tr>
                        ))}
                      </React.Fragment>
                    );
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl shadow-2xl p-6 max-w-md w-full">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-xl font-bold text-gray-800">Update Data Bankeu T1</h3>
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 px-4 py-2 bg-cyan-600 text-white rounded-lg hover:bg-cyan-700 font-medium disabled:bg-gray-300 disabled:cursor-not-allowed"
              >

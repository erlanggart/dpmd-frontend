    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex space-x-2 mb-6">
          <button
            className={`px-4 py-2 rounded-t-lg font-semibold border-b-2 transition-all duration-150 ${activeTab === 'input' ? 'border-blue-600 text-blue-700 bg-white' : 'border-transparent text-gray-500 bg-blue-50 hover:text-blue-700'}`}
            onClick={() => setActiveTab('input')}
          >
            Input Surat
          </button>
          <button
            className={`px-4 py-2 rounded-t-lg font-semibold border-b-2 transition-all duration-150 ${activeTab === 'riwayat' ? 'border-blue-600 text-blue-700 bg-white' : 'border-transparent text-gray-500 bg-blue-50 hover:text-blue-700'}`}

...
import { DollarSign, Activity, ArrowLeft, Clock, FileCheck, RefreshCw } from 'lucide-react';
import api from '../../api';
	...
	const menus = [
		{
			...
			shortTitle: 'ADD',
			description: 'Data penyaluran ADD',
			icon: DollarSign,
		...
		},
		{
			...
			title: 'Dana Desa',
			shortTitle: 'DD',
			description: 'Data penyaluran DD',
			icon: DollarSign,
				...
				<div className="max-w-7xl mx-auto">
					<div className="flex items-center px-4 sm:px-6 py-4 gap-3 sm:gap-4">
						...
						<div className="flex items-center gap-3">
							...
							<div>
								<h1 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900">Bidang KKD</h1>
								<p className="hidden sm:block text-xs sm:text-sm text-gray-500">Keuangan dan Kekayaan Desa</p>
							</div>
						</div>
					</div>
				</div>
						...
						<div className="sticky top-20 space-y-4">
							<div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-4">
								...
								<select
									...
									className="w-full px-3 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm bg-gray-50"
								>

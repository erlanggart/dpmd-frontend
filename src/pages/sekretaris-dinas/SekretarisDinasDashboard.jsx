      ...
      {showNotifications && (
        <>
          ...
          <div className="fixed top-4 right-4 w-96 max-w-[calc(100vw-2rem)] bg-white rounded-2xl shadow-2xl z-50 overflow-hidden border border-gray-100 animate-slideDown">
            {/* Header */}
            <div className="relative bg-gradient-to-r from-purple-500 to-violet-600 px-5 py-4">
            ...
            <div className="max-h-[calc(100vh-12rem)] overflow-y-auto">
              {statistik?.masuk?.pending > 0 ? (
                <div className="p-4">
                  {/* Notification Item */}
                  <div 
                    className="group relative bg-gradient-to-br from-purple-50 to-violet-50 rounded-xl p-4 border border-purple-100 hover:border-purple-300 cursor-pointer transition-all hover:shadow-md"
                    onClick={() => {
                  ...
                  >
                    <div className="flex items-start gap-4">
                      <div className="h-12 w-12 bg-gradient-to-br from-purple-500 to-violet-600 rounded-xl flex items-center justify-center flex-shrink-0 shadow-lg">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-2 text-xs text-purple-600 font-medium group-hover:text-purple-700">
                ...
                <div className="px-6 py-12 text-center">
                  <div className="mx-auto mb-4 h-20 w-20 bg-gradient-to-br from-purple-50 to-violet-100 rounded-2xl flex items-center justify-center">

...
const DdEarmarkedT2 = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      toast.error('Gagal memuat data DD Earmarked Tahap 2');
      setLoading(false);
    }
  };
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const response = await api.post('/dd-earmarked-t2/upload', formData);
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      <div className="mb-6">
        ...
        <p className="text-gray-600 mt-2">Dana Desa Earmarked Tahap 2 Tahun 2025</p>
      </div>

// src/pages/kkd/bhprd/BhprdT1.jsx - BHPRD Tahap 1
...
const BhprdT1 = () => {
  ...
  const fetchFileInfo = async () => {
    try {
      const response = await api.get('/bhprd-t1/info');
  ...
  const fetchBhprdData = async () => {
    try {
      setLoading(true);
      const response = await api.get('/bhprd-t1/data');
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const response = await api.post('/bhprd-t1/upload', formData, {
        headers: {
    ...
    <div className="p-6 bg-gray-50 min-h-screen">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-600 mt-2">
          Data realisasi BHPRD Tahap 1 untuk desa
        </p>
      </div>

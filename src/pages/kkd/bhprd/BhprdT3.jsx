// src/pages/kkd/bhprd/BhprdT3.jsx - BHPRD Tahap 3
...
const BhprdT3 = () => {
  ...
  const fetchFileInfo = async () => {
    try {
      const endpoint = isVpnUser() ? '/vpn-core/bhprd-t3/info' : '/bhprd-t3/info';
  ...
  const fetchBhprdData = async () => {
    try {
      setLoading(true);
      const endpoint = isVpnUser() ? '/vpn-core/bhprd-t3/data' : '/bhprd-t3/data';
      const response = await api.get(endpoint);
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const response = await api.post('/bhprd-t3/upload', formData, {
        headers: {
    ...
    <div className="p-6 bg-gray-50 min-h-screen">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-600 mt-2">
          Data realisasi BHPRD Tahap 3 untuk desa
        </p>
      </div>

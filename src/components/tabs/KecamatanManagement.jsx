// src/components/tabs/KecamatanManagement.jsx
...
const KecamatanManagement = () => {
	...
	const fetchUsers = useCallback(async () => {
		...
		try {
			...
			const kecamatanUsers = response.data.data.filter(
				(user) => user.role === "kecamatan"
			);
			setUsers(kecamatanUsers);
		} catch (err) {
		...
		return (
			<div className="flex justify-center items-center p-12">
				<div className="flex flex-col items-center gap-3">
					<div className="animate-spin rounded-full h-12 w-12 border-b-3 border-violet-500"></div>
		...
		<div className="space-y-6">
			...
			<div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
				<div className="flex items-center gap-3">
					<div className="h-14 w-14 bg-gradient-to-br from-violet-500 to-purple-600 rounded-2xl flex items-center justify-center shadow-lg">
				...
				<button
					...
					className="flex items-center justify-center gap-2 px-5 py-3 bg-gradient-to-r from-violet-500 to-purple-600 text-white rounded-xl hover:from-violet-600 hover:to-purple-700 transition-all duration-200 shadow-lg hover:shadow-xl"
				>
			...
			<div className="relative">
				...
				<input
					type="text"
					placeholder="Cari user berdasarkan nama, email, atau kecamatan..."
					value={searchTerm}
			...
			{filteredUsers.length === 0 ? (
				<div className="text-center py-16 bg-gradient-to-br from-violet-50 to-purple-50 rounded-2xl border-2 border-dashed border-violet-200">
					<div className="flex flex-col items-center gap-4">
						<div className="h-20 w-20 bg-white rounded-2xl flex items-center justify-center shadow-lg">
							<LuMapPin className="h-10 w-10 text-violet-400" />
						</div>
						<div>
							<p className="text-violet-700 font-semibold text-lg mb-1">
								{searchTerm ? "Tidak ada hasil" : "Belum ada user Kecamatan"}
							</p>
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
					{filteredUsers.map((user) => (
						...
						>
							<div className="bg-gradient-to-br from-violet-500 to-purple-600 p-5">
								<div className="flex items-center gap-3">
